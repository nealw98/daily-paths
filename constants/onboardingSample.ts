export const ONBOARDING_SAMPLE = {
  title: "Assets Hidden in Faults",
  hook: "Last week I spent six hours researching the best blender to buy.",
  quote: "We may also find there are assets hidden in our faults.",
  quoteSource: "Paths to Recovery, p. 74",
  body: [
  ...
  practice:
    "I can look at my main character defect and ask: What asset might be hidden in this fault? I can look at my faults to find the potential hidden assets in them. Then I can ask my Higher Power to refine and redirect them.",
